...
See **[deploy/README.md](./deploy/README.md)** for `api.bestbond.in`: one-time clone, `.env`, PM2, nginx, and the **Deploy API** workflow. Generic Nest hosting notes: [NestJS deployment](https://docs.nestjs.com/deployment).
